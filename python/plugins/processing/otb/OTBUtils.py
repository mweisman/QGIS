...
class OTBUtils:
    ...
    OTB_INSTALATION_PATH_OSX = os.path.join(os.path.dirname(QgsApplication.prefixPath()), 'MacOS', 'otb')
    ...
    OTBLIB_INSTALATION_PATH_OSX = os.path.join(os.path.dirname(QgsApplication.prefixPath()), 'MacOS', 'otb','lib')
