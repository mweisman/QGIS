...
class GrassUtils:
    ...
    GRASS_INSTALATION_PATH_OSX = os.path.join(os.path.dirname(QgsApplication.prefixPath()), 'MacOS', 'grass')
    ...
    def grassPath():
        if isWindows():
            return GrassUtils.GRASS_INSTALATION_PATH_WIN
        if isMac():
            return GrassUtils.GRASS_INSTALATION_PATH_OSX
        else:
            return ''
